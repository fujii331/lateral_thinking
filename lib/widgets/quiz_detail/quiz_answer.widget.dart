...
import 'package:lateral_thinking/data/analytics_data_second.dart';
                      ...
                      ? correctAnswerIds.contains(selectedAnswer.value!.id)
                          ? () async {
                              ...
                              if (!enModeFlg) {
                                ...
                                //     data = Analytics(
                                //       hint1: (100 * (hint1Count / userCount))
                                //           .round(),
                                //       hint2: (100 * (hint2Count / userCount))
                                //           .round(),
                                //       noHint: (100 * (noHintCount / userCount))
                                //           .round(),
                                //       subHint:
                                ...
                                final gotAnalyticsData =
                                    ANALYTICS_DATA_SECOND[quizId - 1];
                                data = Analytics(
